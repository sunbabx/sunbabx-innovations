      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col text-left">
            ...
            >
              Reliable <span className="text-cyan-400 relative">IT Solutions</span> &{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-[#E06C1F]">E-Commerce</span> Services
            </motion.h1>
            ...
            >
              SUNBABX-INNOVATIONS specializes in robust IT solutions, e-commerce stores development, digital product sales, and key value-added digital services designed to enrich everyday life and power business success.
            </motion.p>
